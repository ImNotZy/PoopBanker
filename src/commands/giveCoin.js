...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addUserOption(option => option.setName('user').setDescription('The user that will receive the coin').setRequired(true))
    .addIntegerOption(option => option.setName('amount').setDescription('The amount of coin the user will recieve').setRequired(true)),
  async execute(interaction) {
    ...
    try {
      ...
      const updatedCoinCount = user.coin + coinsToAdd;
